...
import pl.coderslab.charity.account.email.EmailSenderService;
...
public class RegistrationService {
    ...
    public String register(UserDto userDto) {
        ...
        emailSender.sendEmail(userDto.getEmail(), "Witamy! Potwierdź swój email", buildEmail(userDto.getEmail(), link));
        return "token";
    }
