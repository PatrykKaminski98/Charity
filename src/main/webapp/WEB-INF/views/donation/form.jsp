        ...
        <form:form modelAttribute="donation" method="post" action="/donation/form">
            ...
            <div data-step="1" class="active">
                ...
                <c:forEach items="${categories}" var="category">
                    <div class="form-group" id="checkbox">
                        <form:checkbox path="categories" value="${category}" id="categories"/>
            ...
            <div data-step="2">
                ...
                <div class="form-group form-group--inline">
                    <label>
                        Liczba 60l worków:
                        <form:input type="number" id="bags" step="1" min="1"  path="quantity"/>
                    </label>
                </div>
            ...
            <div data-step="3">
                ...
                <c:forEach items="${institutions}" var="institution">
                    <div class="form-group form-group--checkbox">
                        <label>
                            <form:radiobutton path="institution" value="${institution}" id="institution"/>
            ...
            <div data-step="4">
                ...
                <div class="form-section form-section--columns">
                    <div class="form-section--column">
                        ...
                        <div class="form-group form-group--inline">
                            <label>
                                Kod pocztowy <form:input path="zipCode" type="text" id="postCode" />
                            </label>
                        </div>

                        <div class="form-group form-group--inline">
                            <label>
                                Numer telefonu <form:input path="phoneNumber" type="tel" id="phone" />
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-section--column">
                        ...
                        <div class="form-group form-group--inline">
                            <label> Godzina <form:input path="pickUpTime" type="time" id="time" value="00:00"/> </label>
                        </div>
                        ...
                        <ul>
                            <li>
                                ...
                                <span class="summary--text">
                                    <span id="summaryBags"></span> worki <span id="summaryCategories"></span></span
                                >
                            </li>
                            ...
                            <li>
                                ...
                                <span class="summary--text"
                                ><span id="summaryInstitution"></span></span
                                >
                            </li>
                        </ul>
                    </div>
