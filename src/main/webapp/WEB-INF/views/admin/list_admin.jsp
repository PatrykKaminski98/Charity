...
<div class="table-wrapper">
    <table class="fl-table">
        ...
        <tr>
            <td>${admin.id}</td>
            <td>${admin.email}</td>
            <c:if test="${admin.email != user}">
                <td><a href="/admin/deleteAdmin/${admin.id}"><span id="delete" class="icon-minus"/></a></td>
                <td><a href="/admin/editAdmin/${admin.id}"><span class="icon-settings"/></a></td>
            </c:if>
        </tr>
        </c:forEach>
        <tbody>
